...
class ExecutionContractTest {
    ...
    @BeforeEach void setup() {
        ...
        FollowerSession.setTimestampSupplier(() -> time);
    ...
    @AfterEach void cleanup() {
        ...
        FollowPath.clearPendingEventTriggers();
        FollowPathV2.clearPendingEventTriggers();
        FollowerSession.setTimestampSupplier(null);
        FollowerSession.setDoubleLoggingConsumer(value -> {});
    }
    ...
    @Test void singleWaypointInterpolatesItsEndingHeadingFromTheMeasuredStart() {
        ...
        FollowerSession.setDoubleLoggingConsumer(value -> samples.put(value.getFirst(), value.getSecond()));
    ...
    @Test void telemetryMigratesExistingSignalsWithoutTakingOverLegacyCallbacksOrLaterCommands() {
        ...
        FollowerSession.setDoubleLoggingConsumer(value -> legacy.put(value.getFirst(), value.getSecond()));
