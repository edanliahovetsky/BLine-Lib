...
final class TranslationProgress {
    ...
    private final List<Pair<PathElement, PathElementConstraint>> elements;
    private final Translation2d origin;
    private int index;

    TranslationProgress(List<Pair<PathElement, PathElementConstraint>> elements, Pose2d start) {
