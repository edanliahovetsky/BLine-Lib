...
public final class FollowPath implements Command {
    ...
    public static final class Builder {
        ...
        public FollowPath build(Path path) {
            return new FollowPath(drive, new FollowerSession(path, config, shouldFlip, EVENTS::begin).withTelemetry(telemetry));
        }
    }

    private FollowPath(Mechanism drive, FollowerSession follower) {
