 ...
 * Pose reset is off by default. Tank direction comes from the path unless overridden; missing direction means Forward.
 * Backward travel does not reverse element order. All velocities supplied and returned by the robot callbacks are robot-relative, in m/s
...
public final class FollowPathV2 extends Command {
    ...
    private final FollowerSession follower;
    ...
    /**
     * Overrides rotation globally for both Commands v2 and v3 followers.
     *
    ...
    public static void overrideRotation(DoubleSupplier supplier, RotationOverrideBehavior behavior) {
        ...
        FollowerSession.overrideRotation(supplier, FollowerSession.RotationOverrideBehavior.valueOf(behavior.name()));
    }
    ...
    public static void clearRotationOverride() {
        FollowerSession.clearRotationOverride();
    }
    ...
    public static void setPoseLoggingConsumer(Consumer<Pair<String, Pose2d>> consumer) {
        FollowerSession.setPoseLoggingConsumer(consumer);
    }
    ...
    public static void setTranslationListLoggingConsumer(Consumer<Pair<String, Translation2d[]>> consumer) {
        FollowerSession.setTranslationListLoggingConsumer(consumer);
    }
    ...
    public static void setBooleanLoggingConsumer(Consumer<Pair<String, Boolean>> consumer) {
        FollowerSession.setBooleanLoggingConsumer(consumer);
    }
    ...
    public static final class Builder {
        ...
        public Builder(DriveType driveType, Subsystem drive, Supplier<Pose2d> poseSupplier,
            ...
            config = new FollowerSession.Config(driveType, poseSupplier, resetPose, measuredVelocity,
        ...
        public Builder withDefaultShouldFlip() {
            return withShouldFlip(FollowerSession::redAlliance);
        }
        ...
        public FollowPathV2 build(Path path) {
            return new FollowPathV2(drive, new FollowerSession(path, config, shouldFlip, EVENTS::begin).withTelemetry(telemetry));
        }
    }

    private FollowPathV2(Subsystem drive, FollowerSession follower) {
